...
//    }
    ...
    fun formatTitleDate(input: String): String {
        ...
        // Optional: get day of week if needed
        val dayOfWeek = dateTime.dayOfWeek.getDisplayName(TextStyle.SHORT, Locale.ENGLISH) // e.g., "Mon"

        // Format date to "yyyy-MM-dd"
        val outputFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd")
        val formattedDate = dateTime.format(outputFormatter)

        // Return formatted string with optional day of week
        return "$dayOfWeek $formattedDate"
    }
